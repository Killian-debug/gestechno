...
func Add(w http.ResponseWriter, r *http.Request) {
	...
	if strings.TrimSpace(record.FirstName) == "" || strings.TrimSpace(record.LastName) == "" || strings.TrimSpace(record.Number) == "" {
	...
	if err != mongo.ErrNoDocuments {
		goutilities.APIResult(&w, http.StatusBadRequest, goutilities.ErrorsRender("The user already exists", err))
		return
	}
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't create the user, please retry", err))
		return
	}
...
func List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't pull user from db", err))
		return
	}
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't read user from db", err))
		return
	}
...
func Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't delete the user", err))
		return
	}
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't update the user", err))
		return
	}
