...
func Add(w http.ResponseWriter, r *http.Request) {
	...
	if strings.TrimSpace(record.Adresse) == "" || strings.TrimSpace(record.Number) == "" {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't create the fournisseurs, please retry", err))
		return
	}
...
func List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't pull Fournisseurs from db", err))
		return
	}
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't read Fournisseurs from db", err))
		return
	}
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't return Fournisseurs data", err))
		return
	}
...
func Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't delete the Fournisseurs", err))
		return
	}
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		goutilities.APIResult(&w, http.StatusInternalServerError, goutilities.ErrorsRender("Can't update the Fournisseurs", err))
		return
	}
...
func SeekCustom(w http.ResponseWriter, r *http.Request) {
	...
	filter := bson.M{"$or": bson.A{
		bson.M{"_Adresse": bson.M{"$regex": ".*" + sSearch + ".*", "$options": "i"}},
